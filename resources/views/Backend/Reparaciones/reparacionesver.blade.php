                                    ...
                                    <div class="col-md-4 my-1">
                                        ...
                                        <div class="input-group input-group-outline">
                                            ...
                                            <input type="text" class="form-control" name="imei" id="imei"
                                                ...
                                                value="{{ old('imei', $rep_actual[0]->imei) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-5 my-1">
                                        ...
                                        <div class="input-group input-group-static">
                                            <textarea name="descripcion" class="form-control" rows="3" placeholder="Descripción del problema..."
                                                spellcheck="false">{{ $rep_actual[0]->descripcion }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-2 my-1">
                                        <p><strong>Prioridad</strong></p>
                                        <select class="select2 prioridad" name="prioridad" id="prioridad"
                                    ...
                                    <div class="col-md-2 my-1">
                                        ...
                                        <div class="input-group input-group-static my-3">
                                            <input name="fecha_entrega" type="datetime-local" class="form-control"
                                                value="{{ $rep_actual[0]->fecha_entrega }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3 my-1">
                                        <p><strong>Responsable</strong></p>
                                        <select class="select2 responsable" name="responsable" id="responsable"
                                            style="width: 100%" height="100px">
                                            <option></option>
                        ...
                        <div class="modal-body">
                            <div class="input-group input-group-outline">
                                <br><input name="patron" type="text" class="form-control" id="patron_inp"
                                    style="font-size: 30px;" value="{{ $rep_actual[0]->patron }}">
                            </div>
...
@push('custom-scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            // dispositivos
            $('#dispositivos').val("{{ $rep_actual[0]->id_device }}");
            $('#dispositivos').select2().trigger('change');

            // prioridad
            if ("{{ $rep_actual[0]->prioridad }}") {
                $('#prioridad').val("{{ $rep_actual[0]->prioridad }}");
                $('#prioridad').select2().trigger('change');
            }

            // responsable
            $('#responsable').val("{{ $rep_actual[0]->usuarioid }}");
